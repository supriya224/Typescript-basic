...
const Counter: React.FC = () => {
  ...
  return (
    <div className="container w-[50vw] h-[50vh] sm:w-1/2 md:flex sm:mt-0 flex flex-wrap  mx-[25rem] my-0 py-9 gap-4 fixed bg-indigo-500 text-white rounded-md shadow-xl shadow-indigo-700 text-center items-center justify-center">
      <h1 className="text-2xl font-bold ">Assignment of Analystt.ai</h1>
      <div className="mx-auto my-9 justify-between gap-9">
        <h1 className="w-28 h-16 mx-72 my-20 text-center justify-center p-4 text-2xl rounded-md bg-indigo-800">{state.count}</h1>
        <div className="justify-between w-full h-12 flex container text-lg ">
